             ...
             <div class="col-md-12">
                 <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        $query =  "SELECT * FROM orientation , doctors where id_patient='$id_p' and doctors.id=orientation.id_doctor" ;
                        ...
                        if(mysqli_num_rows($res) < 1) {
                            ...
                            <table class='table table-bordered'>
                                <tr>
                                    <td class='text-center' colspan='5' style='font-size: 20px; color: red;'>No Orientation Yet.</td>
                                </tr>
                            </table>     
                            ";
                        }
                        ...
                        while($row = mysqli_fetch_array($res)) {
                            ...
                            <table class='table table-bordered border border-dark my-4' style='font-size: 20px;'>
                                ...
                                <tr>
                                    <td class='border border-dark'>Doctor Last-Name</td>
                                    <td class='border border-dark'>".$row['LastName']."</td>
                                </tr>

                                <tr>
                                    <td class='border border-dark'>Orientation To</td>
                                    <td class='border border-dark'>".$row['Orientation']."</td>
                                </tr>

                                <tr>
                                    <td class='border border-dark'>Date Orientation</td>
                                    <td class='border border-dark'>".$row['date_orientation']."</td>
                                </tr>
