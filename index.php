...
<div class="container">
    ...
    <div class="row min-vh-100 align-items-center text-center text-md-left">
        ...
        <div class="col-md-6 pl-md-5 content" data-aos="fade-left">
            ...
            <a href="LearnMore.php"><button class="button">learn more</button></a>
        </div>
...
<div class="box-container">
    ...
    <div class="box" data-aos="zoom-in">
        <a href="images/Facilities1.jpg" title="our team">
            <img src="images/Facilities1.jpg" alt="">
        </a>
    </div>

    <div class="box" data-aos="zoom-in">
        <a href="images/Facilities2.jpg" title="our lab">
            <img src="images/Facilities2.jpg" alt="">
        </a>
    </div>

    <div class="box" data-aos="zoom-in">
        <a href="images/Facilities3.jpg" title="emergency rooms">
            <img src="images/Facilities3.jpg" alt="">
        </a>
    </div>

    <div class="box" data-aos="zoom-in">
        <a href="images/Facilities4.jpg" title="expert doctors">
            <img src="images/Facilities4.jpg" alt="">
        </a>
    </div>

    <div class="box" data-aos="zoom-in">
        <a href="images/Facilities5.jpg" title="expert doctors">
            <img src="images/Facilities5.jpg" alt="">
        </a>
    </div>

    <div class="box" data-aos="zoom-in">
        <a href="images/Facilities6.jpg" title="emergency rooms">
            <img src="images/Facilities6.jpg" alt="">
        </a>
    </div>

    <div class="box" data-aos="zoom-in">
        <a href="images/Facilities7.jpg" title="expert doctors">
            <img src="images/Facilities7.jpg" alt="">
        </a>
    </div>

    <div class="box" data-aos="zoom-in">
        <a href="images/Facilities8.jpg" title="emergency rooms">
            <img src="images/Facilities8.jpg" alt="">
        </a>
    </div>

    <div class="box" data-aos="zoom-in">
        <a href="images/Facilities9.jpg" title="enough beds">
            <img src="images/Facilities9.jpg" alt="">
        </a>
    </div>
